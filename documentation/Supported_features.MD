...
- 🟡 Fields (supported but additional work may be needed for some complex fields or form fields)
...
- ⌛ Lists (currently rendered as regular paragraphs with indentation, without the bullet/number)
- ⌛ Pictures
- ⌛ Math formulas
- ✅ Tables
