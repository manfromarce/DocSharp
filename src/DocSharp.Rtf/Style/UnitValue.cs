...
public struct UnitValue : IEquatable<UnitValue>, IComparable<UnitValue>
{
    ...
    /// <summary>
    /// Convert the measurement to EMUs
    /// </summary>
    /// <returns>The measurement in EMUs</returns>
    public int ToEmus()
    {
        // 1 inch = 914400 EMU; 1 mm = 36000 EMU; 1 pt = 12700 EMU; 1 twip = 635 EMU
        return (int)(ToPt() * 12700);
    }
