...
internal class Element : Node
{
    ...
    internal string? ListTextFallback = string.Empty;
    internal string? ListTextFont = string.Empty;
    ...
    public bool IsLast()
    {
        return Parent != null && Parent.Nodes().Last() == this;
    }
