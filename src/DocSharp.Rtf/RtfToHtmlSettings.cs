...
/// </summary>
public class RtfToHtmlSettings : HtmlWriterSettings
{
    /// <summary>
    /// Image converter to preserve WMF, EMF and other image types when converting to HTML.  
