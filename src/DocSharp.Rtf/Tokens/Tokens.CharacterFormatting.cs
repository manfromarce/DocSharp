...
public class FitText : ControlWord<int>
{
    public override string Name => "fittext";
    public override TokenType Type => TokenType.CharacterFormat;

    public FitText(int value) : base(value) { }
}

public class Expand : ControlWord<int>
{
    public override string Name => "expndtw";
    public override TokenType Type => TokenType.CharacterFormat;

    public Expand(int value) : base(value) { }
}

public class Kerning : ControlWord<int>
{
    public override string Name => "kerning";
    public override TokenType Type => TokenType.CharacterFormat;

    public Kerning(int value) : base(value) { }
}
