...
public partial class DocxToHtmlConverter : DocxConverterBase
{
    ...
    internal bool ProcessTableCellProperties(TableCell cell, ref List<string> cellStyles, int rowNumber, int columnNumber, int rowCount, int columnCount, out int rowSpan, out int columnSpan)
    {
        ...
        if (fitText != null && (fitText.Val == null || fitText.Val.Value == OnOffOnlyValues.On))
        {
    ...
    internal void ProcessTableCell(TableCell cell, StringBuilder sb, List<string> styles, int rowSpan, int colSpan)
    {
        sb.Append("<td");
